...
export const DefaultWithLabel = () => <Textarea placeholder="Enter something.." label="Comment" />
export const DisabledWithLabel = () => <Textarea placeholder="Enter something.." label="Comment" disabled />
...
export const DefaultWithDanger = () => (<Textarea
  label="Comment"
...
export const DefaultWithSuccess = () => (<Textarea
  label="Comment"
  value="The quick brown fox jumps over the lazy dog"
  readOnly
  status="success"
