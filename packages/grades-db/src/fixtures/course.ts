  ...
  [
    {
      ...
      code: "TDT4100",
      nameNo: "Objektorientert programmering",
      ...
      learningOutcomesNo: `Kunnskap: Studentene skal ha kunnskap om de viktigste begrepene og mekanismene i objektorienterte språk og om hvordan objektorienterte programmer og enkle apps struktureres og testes.
...
Kompetanse: Studentene skal kunne bruke objektorientert programmering for å løse praktiske problemer og utnytte mulighetene i moderne utviklingsverktøy.`,
      ...
      examTypeNo: "Skriftlig skoleeksamen",
      candidateCount: 850,
      averageGradeLastThreeYears: 3.7,
      passRateLastThreeYears: 81,
      campuses: ["TRONDHEIM"],
    ...
    },
    {
      ...
      code: "TMA4100",
      nameNo: "Matematikk 1",
      nameEn: "Mathematics 1 - Single variable calculus",
      credits: 7.5,
      studyLevel: "FOUNDATION",
      gradeType: "LETTER",
      ...
      examTypeNo: "Skriftlig skoleeksamen",
      candidateCount: 34778,
      averageGradeLastThreeYears: 2.1533446712018147,
      passRateLastThreeYears: 78.52665478175858,
      campuses: ["TRONDHEIM"],
      taughtSemesters: ["AUTUMN"],
      teachingLanguages: ["NORWEGIAN"],
    },
    {
      ...
      code: "TMA4105",
      nameNo: "Matematikk 2",
      nameEn: "Mathematics 2 - Multivariable calculus and vector analysis",
      credits: 7.5,
      studyLevel: "FOUNDATION",
      gradeType: "LETTER",
      ...
      teachingMethodsNo:
        "Forelesninger og obligatoriske øvinger. Antall øvinger som må godkjennes vil bli oppgitt ved semesterstart på hjemmesiden til emnet. Deler av undervisningen kan bli gitt på engelsk.",
      examTypeNo: "Skriftlig skoleeksamen",
      candidateCount: 28837,
      averageGradeLastThreeYears: 2.08425897748022,
      passRateLastThreeYears: 74.76159101154767,
      campuses: ["TRONDHEIM"],
      taughtSemesters: ["SPRING"],
      teachingLanguages: ["NORWEGIAN"],
    },
    {
      ...
      code: "TDT4110",
      nameNo: "Informasjonsteknologi, grunnkurs",
      nameEn: "Information Technology, Introduction",
      credits: 7.5,
      studyLevel: "FOUNDATION",
      gradeType: "LETTER",
      firstYearTaught: 2003,
      ...
      teachingMethodsNo: "Forelesninger, øvingsforelesninger, auditorieøvinger, obligatoriske øvinger.",
      examTypeNo: "Skriftlig skoleeksamen",
      candidateCount: 22686,
      averageGradeLastThreeYears: 2.7633633308034264,
      passRateLastThreeYears: 90.99003790884245,
      campuses: ["TRONDHEIM"],
      taughtSemesters: ["AUTUMN"],
      teachingLanguages: ["NORWEGIAN"],
    },
    {
      ...
      code: "TMA4115",
      nameNo: "Matematikk 3",
      nameEn: "Mathematics 3 - Linear algebra",
      credits: 7.5,
      studyLevel: "FOUNDATION",
      gradeType: "LETTER",
      firstYearTaught: 2004,
      ...
      teachingMethodsNo: "Forelesninger og obligatoriske øvinger. Deler av mnet kan bli forelest på engelsk.",
      examTypeNo: "Skriftlig skoleeksamen",
      candidateCount: 18281,
      averageGradeLastThreeYears: 2.5789635458289797,
      passRateLastThreeYears: 84.73825283080794,
      campuses: ["TRONDHEIM"],
      taughtSemesters: ["SPRING"],
      teachingLanguages: ["NORWEGIAN"],
    },
    {
      ...
      teachingMethodsNo: "Forelesninger og øvinger. Deler av undervisningen kan bli gitt på engelsk.",
      examTypeNo: "Skriftlig skoleeksamen",
      candidateCount: 17678,
      averageGradeLastThreeYears: 2.196732996732997,
      passRateLastThreeYears: 81.1064600067881,
      campuses: ["TRONDHEIM"],
      taughtSemesters: ["SPRING"],
      teachingLanguages: ["NORWEGIAN"],
    },
    {
      ...
      code: "TDT4120",
      nameNo: "Algoritmer og datastrukturer",
      ...
      teachingMethodsNo: "Forelesninger og individuelle øvinger.",
      examTypeNo: "Skriftlig skoleeksamen",
      candidateCount: 15897,
      averageGradeLastThreeYears: 2.007161678264982,
      passRateLastThreeYears: 75.80046549663459,
      campuses: ["TRONDHEIM"],
      taughtSemesters: ["AUTUMN"],
      teachingLanguages: ["NORWEGIAN"],
    },
    {
      ...
      teachingMethodsNo: "Forelesninger, øvingsforelesninger, auditorieøvinger og obligatoriske øvinger.",
      examTypeNo: "Skriftlig eksamen",
      candidateCount: 15696,
      averageGradeLastThreeYears: 2.584097859327217,
      passRateLastThreeYears: 88.02879714576962,
      campuses: ["TRONDHEIM"],
      taughtSemesters: ["AUTUMN"],
      teachingLanguages: ["NORWEGIAN"],
    },
    {
      ...
      teachingMethodsNo: "Forelesninger og øvinger. Deler av undervisningen kan bli gitt på engelsk.",
      examTypeNo: "Skriftlig skoleeksamen",
      candidateCount: 14626,
      averageGradeLastThreeYears: 2.2266703289157457,
      passRateLastThreeYears: 81.79269793518392,
      campuses: ["TRONDHEIM"],
      taughtSemesters: ["AUTUMN"],
      teachingLanguages: ["NORWEGIAN"],
    },
    {
      ...
      learningOutcomesNo:
        "1. Kunnskap. Studenten kan gjenkjenne, forstå og anvende grunnleggende begreper og metoder fra lineæralgebra i Euklidske rom og system av differensialligninger.\n\n2. Ferdigheter. Studenten kan anvende sin kunnskap om lineæralgebra og system av differensialligninger til å formulere og løse problemer i matematikk og naturvitenskap/teknologi, om nødvendig supplert med bruk av matematisk programvare.",
      teachingMethodsNo: "Forelesninger og obligatoriske øvinger. Deler av emnet kan bli forelest på engelsk.",
      examTypeNo: "Skriftlig skoleeksamen",
      candidateCount: 13394,
      averageGradeLastThreeYears: 2.4490994518402514,
      passRateLastThreeYears: 84.50052262206958,
      campuses: ["TRONDHEIM"],
      taughtSemesters: ["AUTUMN"],
      teachingLanguages: ["NORWEGIAN"],
    },
    {
      ...
      code: "TDT4102",
      nameNo: "Prosedyre- og objektorientert programmering",
      nameEn: "Procedural and Object-Oriented Programming",
      credits: 7.5,
      studyLevel: "FOUNDATION",
      gradeType: "LETTER",
      ...
      teachingMethodsNo: "Ukentlige forelesninger og obligatoriske øvinger.",
      examTypeNo: "Skriftlig skoleeksamen",
      candidateCount: 11716,
      averageGradeLastThreeYears: 2.4915720043972143,
      passRateLastThreeYears: 85.37043359508364,
      campuses: ["TRONDHEIM"],
      taughtSemesters: ["SPRING"],
      teachingLanguages: ["NORWEGIAN"],
    },
    {
      ...
      code: "TMA4130",
      nameNo: "Matematikk 4N",
      nameEn: "Mathematics 4N - Differential equations and Fourier analysis",
      credits: 7.5,
      ...
      teachingMethodsNo: "Forelesninger og obligatoriske øvinger. Emnet kan bli forelest på engelsk.",
      examTypeNo: "Skriftlig skoleeksamen",
      candidateCount: 11634,
      averageGradeLastThreeYears: 2.2819249036652027,
      passRateLastThreeYears: 80.33350524325253,
      campuses: ["TRONDHEIM"],
      taughtSemesters: ["AUTUMN"],
    ...
    },
    {
      ...
      examTypeNo: "Mappevurdering",
      candidateCount: 11584,
      averageGradeLastThreeYears: 3.30093232044199,
      passRateLastThreeYears: 98.23895027624309,
      campuses: ["TRONDHEIM"],
      taughtSemesters: ["SPRING", "AUTUMN"],
      teachingLanguages: ["NORWEGIAN"],
    },
    {
      id: "d313c0f6-aff5-4c0e-93a7-c493bda6d00e",
      code: "HMS0002",
      nameNo: "HMS-kurs for 1. årsstudenter",
      nameEn: "Health, Safety and Environment (HSE) course for 1st year students",
      credits: 0,
      studyLevel: "FOUNDATION",
      gradeType: "PASS_FAIL",
      ...
      examTypeNo: "Deltakelse på HMS-kurs",
      candidateCount: 11369,
      averageGradeLastThreeYears: 0,
      passRateLastThreeYears: 88.4422552555194,
      campuses: ["TRONDHEIM"],
      taughtSemesters: ["SPRING", "AUTUMN"],
      teachingLanguages: ["NORWEGIAN"],
    },
    {
      ...
      code: "EXPH0300",
      nameNo: "Examen philosophicum for naturvitenskap og teknologi",
      nameEn: "Examen philosophicum for Science and Technology",
      credits: 7.5,
      studyLevel: "UNKNOWN",
      gradeType: "LETTER",
      ...
      examTypeNo: "Hjemmeeksamen/Flervalgeksamen",
      candidateCount: 11291,
      averageGradeLastThreeYears: 3.038614825967585,
      passRateLastThreeYears: 97.0507483836684,
      campuses: ["TRONDHEIM"],
      taughtSemesters: ["SPRING", "AUTUMN"],
      teachingLanguages: ["NORWEGIAN"],
    },
    {
      ...
      teachingMethodsNo: "Forelesninger, eksempelregning, øvinger, fysiske og/eller laboratorieøvinger og selvstudium.",
      examTypeNo: "Skriftlig skoleeksamen",
      candidateCount: 11074,
      averageGradeLastThreeYears: 1.8833220926871561,
      passRateLastThreeYears: 73.11721148636445,
      campuses: ["TRONDHEIM"],
      taughtSemesters: ["SPRING"],
      teachingLanguages: ["NORWEGIAN"],
    },
    {
      ...
      examTypeNo: "Skriftlig skoleeksamen",
      candidateCount: 9607,
      averageGradeLastThreeYears: 2.777838368415312,
      passRateLastThreeYears: 88.20651608202353,
      campuses: ["TRONDHEIM"],
      taughtSemesters: ["SPRING"],
      teachingLanguages: ["NORWEGIAN"],
    },
