...
export const Badge: FC<PropsWithChildren<BadgeProps>> = ({ children, color, variant, className }) => {
  const style = cn(
    ...
    "flex w-fit items-center rounded-md px-2.5 py-0.5 font-medium",
    className
  )
  return (
    <Text element="span" className={style}>
      {children}
    </Text>
  )
}
  ...
  solid: cva("text-sm text-black dark:text-white", {
    variants: {
      color: {
        ...
        slate: "bg-gray-400 text-gray-900 dark:bg-stone-700",
      },
    },
  }),
  ...
  light: cva("text-sm", {
    variants: {
      color: {
        ...
        slate: "bg-gray-300 text-gray-900 dark:bg-stone-800 dark:text-stone-300",
      },
    },
  }),
  ...
  outline: cva("text-sm border", {
    variants: {
      color: {
        ...
        green:
          "border-green-400 text-green-900 bg-green-50 dark:border-green-800 dark:text-green-300 dark:bg-green-950",
        amber:
          "border-amber-400 text-amber-900 bg-amber-50 dark:border-amber-800 dark:text-amber-300 dark:bg-amber-950",
        slate: "border-gray-400 text-gray-900 bg-slate-50 dark:border-stone-700 dark:text-stone-300 dark:bg-stone-950",
      },
    },
  }),
}
