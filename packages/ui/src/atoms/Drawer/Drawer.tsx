  ...
  return (
    <DrawerPortal data-slot="drawer-portal">
      ...
      <DrawerPrimitive.Content
        ...
        className={cn(
          "group/drawer-content bg-white dark:bg-stone-800 fixed z-50 flex h-auto flex-col",
        ...
        {...props}
      >
        <div className="bg-gray-200 dark:bg-stone-700 mx-auto mt-4 hidden h-1 w-[40px] shrink-0 rounded-full group-data-[vaul-drawer-direction=bottom]/drawer-content:block" />
        {children}
      </DrawerPrimitive.Content>
    </DrawerPortal>
  )
