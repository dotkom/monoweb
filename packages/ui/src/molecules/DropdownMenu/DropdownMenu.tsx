...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ...
    className={cn(
      ...
      "border border-slate-5 dark:border-slate-12",
      "rounded-lg p-2",
      "bg-white dark:bg-slate-11",
      className
    )}
    {...props}
  />
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Label
    ref={ref}
    className={cn("text-sm text-slate-11 px-2 py-1.5 font-semibold", inset && "pl-8", className)}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.Separator ref={ref} className={cn("bg-slate-3 dark:bg-slate-10 mx-2 my-1 h-px", className)} {...props} />
))
