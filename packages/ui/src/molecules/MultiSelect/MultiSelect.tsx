...
export const MultiSelect = ({ elements, placeholder  }: MultiSelectProps) => {
  ...
  return (
    <div className="relative">
      <div className="flex flex-wrap items-center gap-2 min-h-[40px] p-2 border border-gray-200 dark:border-stone-700 rounded-md bg-white dark:bg-stone-800 focus-within:ring-2 focus-within:ring-black focus-within:border-gray-200 dark:focus-within:ring-white dark:focus-within:border-white">
