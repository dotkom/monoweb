  ...
  return (
    <div className={cn("flex flex-col gap-3", className)}>
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        {effectiveUrl && !warnSizeError ? (
          <TextLink href={effectiveUrl} target="_blank" rel="noopener noreferrer" className="truncate text-sm">
            {displayName}
          </TextLink>
        ) : (
          <Text className="min-w-0 flex-1 truncate text-sm text-muted-foreground">{displayName}</Text>
        )}
      </div>
