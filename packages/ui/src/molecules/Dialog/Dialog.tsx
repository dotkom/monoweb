...
export const AlertDialogTitle: FC<ComponentPropsWithRef<typeof AlertDialogPrimitive.Title>> = ({
  ...
  return (
    <AlertDialogPrimitive.Title
      ref={ref}
      className={cn("text-slate-12 text-lg font-semibold leading-none tracking-tight", className)}
      {...props}
    />
  )
}
...
export const AlertDialogDescription: FC<ComponentPropsWithRef<typeof AlertDialogPrimitive.Description>> = ({
  ...
  return <AlertDialogPrimitive.Description ref={ref} className={cn("text-slate-10 text-md", className)} {...props} />
}
...
export const AlertDialogCancel: FC<Omit<ComponentPropsWithRef<typeof AlertDialogPrimitive.Cancel>, "color">> = ({
  ...
  return <Button element={AlertDialogPrimitive.Cancel} className={className} {...props} variant="text" size="lg" ref={ref} />
}
