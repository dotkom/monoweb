...
export const MembershipSpecialization = {
  ...
  PROGRAMMING_AND_SECURITY_ENGINEERING: 'PROGRAMMING_AND_SECURITY_ENGINEERING',
  VISUAL_INFORMATICS: 'VISUAL_INFORMATICS',
  UNKNOWN: 'UNKNOWN'
} as const
...
export const TaskType = {
  ...
  SEND_NOTIFICATION_EVENT_REGISTRATION: 'SEND_NOTIFICATION_EVENT_REGISTRATION',
  SEND_NOTIFICATION_EVENT_REMINDER: 'SEND_NOTIFICATION_EVENT_REMINDER',
  SEND_NOTIFICATION_JOB_LISTING_REMINDER: 'SEND_NOTIFICATION_JOB_LISTING_REMINDER'
} as const
