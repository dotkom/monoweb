...
export async function up(db: Kysely<Database>) {
  ...
  await createTableWithDefaults("product", { createdAt: true, id: true, updatedAt: true }, db.schema)
  ...
  await createTableWithDefaults("payment", { createdAt: true, id: true, updatedAt: true }, db.schema)
