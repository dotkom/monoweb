...
export const getGroupFixtures = () =>
  [
    ...
    },
    {
      ...
      description: "Ekskom organiserer Onlines årlige ekskursjon.",
    ...
    },
    {
      ...
      description: "Trivselskomiteen har ansvaret for trivsel blant studentene og drift av kontoret.",
    ...
    },
    {
      ...
      name: "Mineline",
      about: "Mineline er interessegruppen for Onlines Minecraft-server, og som samles av og til for å spille på den.",
