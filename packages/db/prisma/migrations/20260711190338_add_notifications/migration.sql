...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('BROADCAST', 'BROADCAST_IMPORTANT', 'EVENT_REGISTRATION', 'EVENT_REMINDER', 'EVENT_UPDATE', 'JOB_LISTING_REMINDER', 'MARK_UPDATE', 'NEW_ARTICLE', 'NEW_EVENT', 'NEW_FEEDBACK_FORM', 'NEW_INTEREST_GROUP', 'NEW_JOB_LISTING', 'NEW_MARK', 'NEW_OFFLINE');
