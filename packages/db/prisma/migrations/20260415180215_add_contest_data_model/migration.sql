...
-- CreateIndex
CREATE UNIQUE INDEX "contest_winner_contestant_key" ON "contest"("winner_contestant");
...
-- AddForeignKey
ALTER TABLE "contest" ADD CONSTRAINT "contest_winner_contestant_fkey" FOREIGN KEY ("winner_contestant") REFERENCES "contestant"("id") ON DELETE SET NULL ON UPDATE CASCADE;
