...
-- AddForeignKey
ALTER TABLE "user_flag_link" ADD CONSTRAINT "user_flag_link_user_flag_id_fkey" FOREIGN KEY ("user_flag_id") REFERENCES "user_flag"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
VALUES
  ...
  (gen_random_uuid(), 'VANITY_VERIFIED', 'OW Verified er et kosmetisk profiltillegg som vises blant annet i påmeldingslister. Foreløpig har den blitt solgt til høystbydende på Onlines veldedighetsfest.', null)
