...
CREATE TABLE "JobListingLocation" (
    ...
    CONSTRAINT "JobListingLocation_pkey" PRIMARY KEY ("name","jobListingId")
);
...
CREATE TABLE "InterestGroupMember" (
    ...
    CONSTRAINT "InterestGroupMember_pkey" PRIMARY KEY ("interestGroupId")
);
...
-- AddForeignKey
ALTER TABLE "JobListingLocation" ADD CONSTRAINT "JobListingLocation_jobListingId_fkey" FOREIGN KEY ("jobListingId") REFERENCES "JobListing"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "InterestGroupMember" ADD CONSTRAINT "InterestGroupMember_interestGroupId_fkey" FOREIGN KEY ("interestGroupId") REFERENCES "InterestGroup"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "InterestGroupMember" ADD CONSTRAINT "InterestGroupMember_userId_fkey" FOREIGN KEY ("userId") REFERENCES "OwUser"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
