...
export const greenSubtle = () => <Badge variant="green.subtle">GREEN</Badge>;
...
export const graySubtle = () => <Badge variant="gray.subtle">GRAY</Badge>;
export const graySolid = () => <Badge variant="gray.solid">GRAY</Badge>;
export const grayOutline = () => <Badge variant="gray.outline">GRAY</Badge>;
