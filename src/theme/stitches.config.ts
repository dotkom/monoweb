...
type StyleInput<T extends string> = { [key in T]: ReturnType<typeof css> };
 ...
 */
export const createStyles = <T extends string>(styles: StyleInput<T>) => {
  return styles;
};
