...
const LAMBDA_ENDPOINT = "http://localhost:5001/api/kvittering";
...
export default function ReceiptForm() {
	...
	const isTestMode = typeof window !== 'undefined' && window.location.pathname.includes("test");
	...
	async function sendEmail(pdfUrl: string) {
	...
	async function onSubmit(values: z.infer<typeof formSchema>) {
		try {
			...
			await sendEmail(data.data.pdf_url);
		} catch (error) {
