const FooterWave = ({ color, className }: { color: string, className?: string }) => {
	return (
		<svg width="639" height="63" viewBox="0 0 639 63" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
			<path
