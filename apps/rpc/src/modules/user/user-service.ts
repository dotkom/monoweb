...
import type { FeideGroupsRepository, NTNUGroup } from "../feide/feide-groups-repository.ts"
import type { NTNUStudyPlanRepository, StudyplanCourse } from "../ntnu-study-plan/ntnu-study-plan-repository.ts"
import type { NotificationPermissionsRepository } from "./notification-permissions-repository.ts"
import type { PrivacyPermissionsRepository } from "./privacy-permissions-repository.ts"
import { UserFetchError, UserNotFoundError, UserUpdateError } from "./user-error.ts"
