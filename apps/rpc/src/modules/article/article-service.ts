...
export interface ArticleService {
  ...
  findManyByTags(handle: DBHandle, tags: ArticleTagName[]): Promise<Article[]>
  /**
...
export function getArticleService(
  ...
  return {
    ...
    async findManyByTags(handle, tags) {
      return await articleRepository.findManyByTags(handle, tags)
    },
    ...
    async setTags(handle, articleId, tags) {
      ...
      const currentTags = await articleTagRepository.getAllByArticle(handle, articleId)
