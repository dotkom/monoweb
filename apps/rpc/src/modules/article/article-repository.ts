...
export interface ArticleRepository {
  ...
  findBySlug(handle: DBHandle, slug: ArticleSlug): Promise<Article | null>
  findMany(handle: DBHandle, query: ArticleFilterQuery, page: Pageable): Promise<Article[]>
  findManyByTags(handle: DBHandle, tags: ArticleTagName[], page?: Pageable): Promise<Article[]>
