import { Box, Title, NumberInput, Button, Checkbox } from "@mantine/core"
...
interface PoolFormProps {
  onSubmit(values: { min: number; max: number; limit: number }): void
  existingPools: { min: number; max: number }[]
}

export function PoolForm({ onSubmit, existingPools }: PoolFormProps) {
