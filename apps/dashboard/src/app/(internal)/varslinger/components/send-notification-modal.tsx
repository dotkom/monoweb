...
export const SendNotificationModal: FC<ContextModalProps<NotificationLaunchContext>> = ({
  ...
  const [recipientSelection, setRecipientSelection] = useState(() => getDefaultRecipientSelection(launchContext))
  ...
  return (
    <form onSubmit={onSubmit}>
      <Stack gap="lg">
        ...
        {recipientSelection !== null && launchContext.kind !== "GLOBAL" && (
