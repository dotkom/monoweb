...
import { useCreateInterestGroupMutation } from "../mutations/create-interest-group-mutation";
import { useInterestGroupWriteForm } from "src/app/(dashboard)/interest-group/write-form";

export const CreateInterestGroupModal: FC<ContextModalProps> = ({
  context,
  id,
}) => {
...
export const useCreateInterestGroupModal = () => () => {
  console.log("modals", modals.openContextModal);
