...
const CompanySplash: React.FC = () => {
  ...
  const lightSwitch = () => {
    ...
    console.log("current theme from ref: ", currentTheme);
      ...
      >
        <div className="flex flex-col lg:items-center lg:flex-row lg:justify-between text-center lg:text-left">
          <div className="w-full lg:w-[50%] px-6 lg:pr-0 lg:pl-16 lg:pb-8 transition-opacity duration-700 delay-100">
            <h1
              className="relative font-bold pb-2 transition-opacity duration-700 delay-200"
            >
            ...
            <p
              className="font-poppins text-md md:text-lg max-w-xl mb-4 lg:mb-8 mx-auto lg:mx-0 transition-opacity duration-700 delay-500"
            >
          ...
          >
            ...
            <div 
              className="w-full aspect-[10/9] max-w-[600px] mx-auto"
            >
              <Spline
