...
export default async (props: ComponentPropsWithoutRef<"div">) => {
  ...
  return (
    <div
      {...props}
      className={cn("flex justify-between pb-10", props.className)}
    >
      <div className="w-full">
        ...
        <p className="py-4 pr-20">
          ...
          og informatikk (IDI). Dette innebærer blant annet å lære om utvikling,
          forbedring, evaluering og bruk av datasystemer. For mer informasjon om
          studiet, se NTNU sine offisielle nettsider for bachelor og master.
        </p>
