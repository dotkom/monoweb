  ...
  return (
    <div className="flex flex-row gap-2 w-full rounded-lg -mx-2 p-2">
      ...
      <div className="flex flex-col gap-4">
        <div className="w-64 h-6 bg-gray-300 dark:bg-stone-700 rounded-sm animate-pulse" />

        <div className="flex gap-2">
          <div className="w-4 h-4 bg-gray-300 dark:bg-stone-700 rounded-sm animate-pulse" />
          <div className="w-28 h-4 bg-gray-300 dark:bg-stone-700 rounded-sm animate-pulse" />
        </div>

        <div className="flex gap-2">
          <div className="w-4 h-4 bg-gray-300 dark:bg-stone-700 rounded-sm animate-pulse" />
          <div className="w-6 h-4 bg-gray-300 dark:bg-stone-700 rounded-sm animate-pulse" />
        </div>
      </div>
    </div>
  )
