...
export const ComingEvent: React.FC<ComingEventProps> = (props) => {
    return <div className={styles.comingEvent()}>
        ...
        <div className={styles.comingEventInfoContainer()}>
            <span>
                ...
                <div>
                    <Text className={styles.noMargin()} size="lg">{props.title}</Text>
                    <Text className={styles.noMargin()}>{props.date}</Text>
                    <Text className={styles.noMargin()}>{props.attending}/{props.max_attending}</Text>
                </div>
            </span>
        </div>

        <Badge color="green" variant="solid" className={styles.tag()}>{props.tag}</Badge>
...
const styles = {
    ...
    comingEventImage: css({ // Make image height 50px and fit width
        height: "100px",
        width: "100px",
        objectFit: "cover",
    }),
