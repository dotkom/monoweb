      ...
      <HoverCardTrigger asChild>
        ...
        >
          <div className="relative">
            <span className="block text-nowrap text-clip font-semibold sm:font-medium leading-8">
              {event.title}
            </span>
            <div className={`absolute inset-y-0 right-0 w-5 bg-gradient-to-r from-transparent ${theme.item.gradient} pointer-events-none`}/>
          </div>
        </Link>
      </HoverCardTrigger>
      <HoverCardContent 
