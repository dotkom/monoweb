...
export const ProfileInfoBox: FC<ProfileInfoBoxProps> = ({ user }) => {
  const lineStyle = "border-r border-gray-600 last:border-r-0"
  const bio = true

  return (
    <div className="border-gray-600 mt-9 min-w-[970px] rounded-xl left-0 z-0 w-full border flex flex-row justify-evenly py-16">
