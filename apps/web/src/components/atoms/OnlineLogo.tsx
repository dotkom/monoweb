...
export const OnlineLogo: FC<OnlineLogoProps> = ({ className, style = "brand" }) => {
  const lightningFill = "#FAB759"
          ...
          <g transform="matrix(1.33333,0,0,1.33333,886.922,-278.061)">
            ...
            <g transform="matrix(1,0,0,1,20.5964,0)">
              <g transform="matrix(0.75,0,0,0.75,0,8.52651e-14)">
                <rect style={{ fill: textFill }} x="431.307" y="394.604" width="29.6" height="118.751" />
              </g>
              <g transform="matrix(0.75,0,0,0.75,-11.7993,1.7053e-13)">
                <circle style={{ fill: textFill }} cx="461.84" cy="362.79" r="15.732" />
              </g>
            </g>
