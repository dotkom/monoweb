    ...
    <div className="lg:hidden">
      <DropdownMenu open={open} onOpenChange={setOpen}>
        ...
        <DropdownMenuContent
          ...
          side="bottom"
          sideOffset={8}
          className="w-[calc(100vw-2rem)] mx-4 mt-4 p-0 lg:hidden bg-blue-50 z-50 dark:bg-stone-800 [[data-theme=pink]_&]:bg-pink-100 [[data-theme=pink]_&]:border-none border-blue-100 dark:border-stone-700 shadow-sm rounded-3xl"
        >
                    ...
                    <div className="p-2 pt-8 flex justify-between gap-2">
                      ...
                      <DropdownMenuItem asChild>
                        <Button
                          ...
                          variant="solid"
                          size="md"
                          className="font-semibold rounded-md justify-start px-3 h-10 bg-blue-100 [[data-theme=pink]_&]:bg-pink-200 hover:bg-blue-200/80 dark:bg-stone-700/80 dark:hover:bg-stone-600/50 w-fit"
