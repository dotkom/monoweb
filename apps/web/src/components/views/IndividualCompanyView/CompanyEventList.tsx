      ...
      <ul className="mt-4 list-none">
        ...
        {props.isLoading ? (
          ...
          props.events.map((event) => (
            <li
              key={event.id}
              className="border-blue-7 hover:bg-blue-2 grid h-10 w-full gap-x-4 grid-cols-[1fr_10fr_1fr] content-center border-b px-1 py-6 text-lg hover:cursor-pointer"
            >
