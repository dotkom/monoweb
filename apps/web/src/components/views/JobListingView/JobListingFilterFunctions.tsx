...
import { EmploymentCheckbox } from "./JobListingView"
export function filterJobListings(jobListing: JobListing, chosenLocation: string, chosenEmployments: EmploymentCheckbox[], searchName: string, chosenSort: string) {
  return filterLocation(jobListing, chosenLocation) && filterEmployment(jobListing, chosenEmployments) && filterName(jobListing, searchName)
}
