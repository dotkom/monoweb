...
export const JobListingView: FC<JobListingViewProps> = (
  props: JobListingViewProps
) => {
  const {
    title,
    applicationEmail,
    ...
    <div className="mx-auto mt-10 flex w-10/12 justify-between">
      <div className="w-1/3">
        ...
        <Link href="/career">
          <div className="flex items-center">
            <Icon
              ...
              height={20}
            />
            <p className="m-0 border-0 pl-2 text-base text-blue-500">
              {" "}
              ANDRE MULIGHETER
            </p>
          </div>
        ...
        <div className="my-3 flex items-center">
          ...
          {deadline ? (
            <p className="m-0 pl-2">{formatDate(deadline)}</p>
          ) : (
