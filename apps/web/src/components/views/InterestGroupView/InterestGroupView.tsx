...
const InterestGroupViewInner: FC<InnerInterestGroupViewProps> = (props: InnerInterestGroupViewProps) => {
  ...
  return (
    <div className="p-14 my-16 mx-auto border-slate-200 rounded-lg border shadow-md w-10/12 ">
      <Link className="bg-transparent p-0 hover:underline mb-4" href={"/interessegrupper"}>
        {"<"} Tilbake
      </Link>
      <div className="flex md:flex-row flex-col-reverse">
        <div className="mr-4">
          ...
          {interestGroup.link && (
            <Link className="hover:underline text-blue-900 block mt-4" href={interestGroup.link}>
