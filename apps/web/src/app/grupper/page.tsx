      ...
      <Tabs defaultValue="committee">
        <TabsList variant="default" className="h-12! w-full sm:w-135 mb-3">
          <TabsTrigger value="committee">
            Komiteer
            <span className="max-md:hidden text-gray-500 dark:text-stone-400 text-sm">({committees.length})</span>
          </TabsTrigger>
          <TabsTrigger value="nodecommittee">
            Nodekomiteer
            <span className="max-md:hidden text-gray-500 dark:text-stone-400 text-sm">({nodeCommittees.length})</span>
          </TabsTrigger>
          <TabsTrigger value="associated">
            Assosierte grupper
            <span className="max-md:hidden text-gray-500 dark:text-stone-400 text-sm">({associatedGroups.length})</span>
          </TabsTrigger>
        </TabsList>
