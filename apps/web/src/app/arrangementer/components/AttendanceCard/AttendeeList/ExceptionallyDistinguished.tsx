...
import { FlagName, type UserFlag, getFlagLabel } from "@dotkomonline/rpc/user"
...
export function ExceptionallyDistinguishedPlate(props: PlateProps) {
  return (
    <Plate
      {...props}
      className={cn(
        "items-stretch overflow-hidden rounded-lg p-px",
    ...
    >
      <div
        className={cn(
          "pointer-events-none relative flex min-w-0 w-full flex-1 items-center overflow-hidden rounded-[7px]",
          "bg-origin-border",
      ...
      >
        ...
        <Plate.IdentityArea className="px-2 py-1.25">
          <Plate.Avatar
