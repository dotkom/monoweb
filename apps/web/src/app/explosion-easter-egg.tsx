...
import {
  ...
  getRandomExplosionSize,
  getRandomExplosionPosition,
} from "@/utils/explosion-easter-egg"
    ...
    <>
      {isExplodeModeStartAnimation() && (
        ...
        >
          ...
          {[...Array(5)].map(() => (
            // Make 5 explosions appear together with the spinning text
            <div
      ...
      {explosion && (
        ...
        >
          <Image src={explosion.gifUrl} alt="" width={explosion.size} height={explosion.size} />
        </div>
      )}
      <style jsx>{`
          @keyframes spin {
